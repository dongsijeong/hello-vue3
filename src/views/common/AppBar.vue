<template>
  <div>
    <!-- ToolBar -->
    <v-toolbar id="topToolbar" theme="dark" :color="headerBkColor" height="34" :max-width="gamenWidth" :width="gamenWidth">
      ...
      <v-sheet theme="dark" :color="headerBkColor">
        <v-btn theme="dark" size="x-small" color="#ff5252" style="font-size: 13px; height: 25px !important; font-weight: bold !important">終了</v-btn>
      </v-sheet>
      <v-btn @click="print()"><v-icon>mdi-printer</v-icon></v-btn>
      <v-sheet v-dompurify-html="currentDate" theme="dark" :color="headerBkColor" style="font-size: 13px"></v-sheet>
    </v-toolbar>
  </div>
</template>
